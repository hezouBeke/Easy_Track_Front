        ...
        <section className="bg-white dark:bg-gray-200 font-thin">
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <div className="mt-4 md:mt-0">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black">Optimisez le suivi de vos colis avec des outils avancés.</h2>
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Notre plateforme vous offre des outils puissants pour suivre vos colis en temps réel, automatiser les mises à jour et garantir une livraison en toute sécurité. Découvrez comment améliorer la gestion de vos envois.</p>
