        ...
        <section className="bg-white lg:px-2 mb-0 font-thin"> 
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-20">
                ...
                <div className="flex flex-col mb-12 lg:mb-20 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-thin text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-black dark:border-black dark:hover:bg-gray-200 dark:focus:ring-gray-800">
