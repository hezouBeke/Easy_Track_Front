            ...
            {cards.map((card, index) => (
                ...
                >
                    <div className="flex items-end justify-between">
                        <div>
                            <h3 className="text-lg font-thin text-gray-700">{card.title}</h3>
                            <p className="text-2xl font-thin text-gray-900">{card.value}</p>
                        </div>
