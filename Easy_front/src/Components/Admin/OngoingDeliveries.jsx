...
const OngoingDeliveries = () => {
  ...
  const [selectedExpedition, setSelectedExpedition] = useState(""); // État pour l'expédition sélectionnée
  ...
  // Filtrer les courses de l'expédition sélectionnée
  const filteredCourses = selectedExpedition
    ? expeditions
        .find(expedition => expedition.expedition_code === selectedExpedition)
        ?.course_ids
    : expeditions.flatMap(expedition => expedition.course_ids); // Affiche toutes les courses si aucune expédition n'est sélectionnée
  ...
  return (
    <div className="flex flex-col items-start space-y-10 p-7 mt-8 w-full mr-5">
      <div className="p-3 bg-white text-black rounded-lg shadow-lg w-full">
        ...
        {/* Champs de sélection pour l'expédition */}
