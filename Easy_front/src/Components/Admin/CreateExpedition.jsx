...
function CreateExpedition() {
  ...
  return (
    <section className="h-screen flex items-center justify-center bg-gray-100 py-40 ml-36">
    <Adminheader />
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
